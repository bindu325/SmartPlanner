...
import { Eye, EyeOff, Sparkles, GraduationCap, ArrowRight, Lock, Mail, AlertCircle, CheckCircle2, Calendar, BrainCircuit, BookOpen } from 'lucide-react';
        ...
        <div className="lg:col-span-6 bg-gradient-to-br from-[#1A2238] via-[#121829] to-[#1F193C] p-8 sm:p-12 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-white/[0.08] relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-2 pt-4">
              ...
              <p className="text-sm text-slate-300 leading-relaxed font-normal pt-1">
                Turn your course syllabus, topic difficulties, and upcoming exam deadlines into an adaptive, prioritized daily study schedule.
              </p>
            </div>
          </div>

          {/* Micro Visual Card Showcase */}
          <div className="relative z-10 my-8 space-y-2.5 bg-black/30 backdrop-blur-md p-4 rounded-2xl border border-white/[0.08]">
            <div className="flex items-center gap-2 text-xs font-bold text-indigo-300">
              ...
              <span>Multi-Factor Scheduling Engine</span>
            </div>
            <div className="space-y-1.5 text-xs text-slate-300">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
                <span>Urgency-weighted exam countdowns</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
                <span>Multi-phase Learn, Practice & Revision sessions</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
                <span>Dynamic missed-task reallocation</span>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-md mx-auto w-full space-y-6">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-400 mt-1">
                Sign in to your private workspace to view your schedule
              </p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-slate-900 border border-white/[0.08] rounded-xl text-slate-100 placeholder-slate-500 text-sm focus:outline-none focus:border-indigo-500 transition"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    placeholder="••••••••"
                    className="w-full pl-10 pr-10 py-3 bg-slate-900 border border-white/[0.08] rounded-xl text-slate-100 placeholder-slate-500 text-sm focus:outline-none focus:border-indigo-500 transition"
                  />
                  <button
                    type="button"
            ...
            <div className="pt-4 border-t border-white/[0.06] text-center">
              <p className="text-xs text-slate-400">
                ...
                >
                  Create Account <Sparkles className="w-3 h-3 text-amber-400" />
                </Link>
              </p>
            </div>
          </div>
